...
<div class="container">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function(){
        document.getElementById('v_1').innerHTML = vopros_4;
        document.getElementById('v_2').innerHTML = vopros_5;
        document.getElementById('v_3').innerHTML = vopros_6;
        document.getElementById('tema').innerHTML = test2;
    });
    function sled_vopr(){
