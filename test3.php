...
<div class="container">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function(){
        document.getElementById('v_1').innerHTML = vopros_7;
        document.getElementById('v_2').innerHTML = vopros_8;
        document.getElementById('v_3').innerHTML = vopros_9;
        document.getElementById('tema').innerHTML = test3;
    });
    function sled_vopr(){
